...
/*
** ===================================================================
**     Event       :  MeuDMA_OnComplete (module Events)
**
**     Component   :  MeuDMA [DMATransfer_LDD]
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
void MeuDMA_OnComplete(LDD_TUserData *UserDataPtr)
{
  /* Write your code here ... */
	DMA_PDD_SetByteCount(DMA_BASE_PTR, 0, lenDmaSrc);
}
