...
unsigned long totalAmostra;
unsigned long contAmostra;
*/
...
/*
** ===================================================================
**     Event       :  TimerClockInt1_OnInterrupt (module Events)
**
**     Component   :  TimerClockInt1 [TimerInt]
**     Description :
...
** ===================================================================
*/
void TimerClockInt1_OnInterrupt(void)
{
  /* Write your code here ... */
	if(contClock<=128)
	{
